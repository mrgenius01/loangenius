    ...
    try:
        ...
        with app.app_context():
            ...
            with engine.connect() as conn:
                ...
                if dialect == 'sqlite':
                    ...
                    if 'users' in tables:
                        ...
                        conn.execute("UPDATE users SET user_type = 'admin' WHERE user_type IS NULL")
                    ...
                    try:
                        ...
                        print(f"  ⚠️  Could not analyze users table: {e}")
            ...
            try:
                ...
                print(f"  ✓ Loans table: 0 records (new table)")
            
            try:
                transaction_count = Transaction.query.count()
                print(f"  ✓ Transactions table: {transaction_count} records")
            except Exception as e:
                print(f"  ✓ Transactions table: 0 records (accessible)")
            ...
            print("  ✓ All required columns in users table")
            print("  ✓ New loans and login_attempts tables")
